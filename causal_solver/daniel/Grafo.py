...
def create_graph(file_path="/home/lawand/Canonical-Partition/test_cases/inputs/balke_pearl.txt"):
    numberOfNodes, labelToIndex, indexToLabel, adj, cardinalities, parents, interventions = parseFile(file_path)
    ...
    return Grafo(numberOfNodes=numberOfNodes,currNodes=[], visited=[False] * (numberOfNodes), cardinalities=cardinalities, parents=parents,
                ...
                cComponentToUnob = {}, graphNodes=graphNodes,interventions=interventions)
